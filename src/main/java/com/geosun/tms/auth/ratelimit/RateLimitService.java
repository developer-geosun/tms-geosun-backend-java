...
public class RateLimitService {
    ...
    public void checkRegister(String clientIp) {
        ...
        slidingWindowAllow(key, registerHits, properties.getRegisterMaxPerWindow(), properties.getLoginWindowSeconds());
    }
    ...
    public void checkRefresh(String clientIp) {
        ...
        slidingWindowAllow(key, refreshHits, properties.getRefreshMaxRequests(), properties.getRefreshWindowSeconds());
    }

    private void slidingWindowAllow(String key, ConcurrentHashMap<String, Deque<Long>> map, int max, int windowSeconds) {
